import { AuthDynamicPayload, AuthenticatablePasswordPayload } from '../Authentication.types'
...
export default class IsAuthenticatablePasswordDynamic {
  public perform(payload: AuthDynamicPayload<AuthenticatablePasswordPayload>): boolean {
