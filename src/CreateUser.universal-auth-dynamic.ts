...
import { DefaultModuleDynamicNames, EmailPasswordLocalePayload } from './types'

@AuthDynamic<DefaultModuleDynamicNames>('default', 'create-user', true)
export default class CreateUserDynamic {
  public async perform(payload: EmailPasswordLocalePayload, authentication: Authentication): Promise<unknown> {
